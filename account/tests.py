...
class PermissionDecoratorTest(APITestCase):
    def setUp(self):
        self.regular_user = User.objects.create(username="regular_user", email="123@123.com")
        self.admin = User.objects.create(username="admin", email="124@123.com")
        self.super_admin = User.objects.create(username="super_admin", email="125@123.com")
...
class UserProfileAPITest(APITestCase):
    ...
    def test_update_profile(self):
        ...
        self.assertEqual(data["accepted_number"], 0)
...
class ApplyResetPasswordAPITest(APITestCase):
    def setUp(self):
        self.create_user("test", "test123", login=False)
        user = User.objects.first()
